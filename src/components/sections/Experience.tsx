...
const experiences: Experience[] = [
  {
    ...
    bullets: [
      "Training ML models to spot network intrusions in real time — think of it as teaching a system to recognize the difference between normal traffic and a DDOS attack before it hits",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Owned the testing story end-to-end with JUnit and Mockito, pushing coverage past 90% so the team could ship with confidence",
      "Got hands-on with Terraform and Jenkins to keep infrastructure reproducible and deployments smooth across environments",
    ],
  ...
  },
  {
    ...
    team: "EC2 Elastic Load Balancing",
    location: "Seattle, WA",
